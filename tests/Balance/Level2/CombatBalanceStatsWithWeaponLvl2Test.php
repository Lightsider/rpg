 ...
 *   Hybrid/Uni  → Balanced
 */
class CombatBalanceStatsWithWeaponLvl2Test extends TestCase
{
    ...
    {
        return ['str' => 12, 'con' => 12, 'dex' => 0, 'wit' => 0];
    }

    private function createCritStats(): array
    {
        return ['str' => 6, 'con' => 12, 'dex' => 0, 'wit' => 6];
    }

    private function createHybridStats(): array
    {
        return ['str' => 9, 'con' => 12, 'dex' => 0, 'wit' => 3];
    }
    ...
    {
        return ['str' => 12, 'con' => 6, 'dex' => 6, 'wit' => 0];
    }

    private function createUniversalStats(): array
    {
        return ['str' => 12, 'con' => 9, 'dex' => 3, 'wit' => 0];
    }
