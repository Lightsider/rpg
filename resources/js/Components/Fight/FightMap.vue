    ...
    <div class="fight-map" :style="gridStyle">
        ...
        >
            ...
            >
                ...
                <div v-if="getFighterAt(x - 1, y - 1)" class="fighter flex items-center justify-center"
                     :class="[
                        getFighterAt(x - 1, y - 1).character_id === myCharacterId ? 'fighter-me' : 'fighter-enemy',
                        getTeamClass(getFighterAt(x - 1, y - 1)),
                        getFighterAt(x - 1, y - 1).hp <= 0 ? 'fighter-dead opacity-60' : ''
                     ]">
                     <svg v-if="getFighterAt(x - 1, y - 1).hp <= 0" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white" viewBox="0 0 20 20" fill="currentColor">
